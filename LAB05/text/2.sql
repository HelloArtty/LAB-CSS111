...
-- INSERT into Foods values (8, 'Bean soup with bacon', '1cup', 30.8, 'Soups, Sauces and Gravies', 4); 
...
-- 2.3
-- SELECT Name,C,Fiber FROM Foods ORDER by C ASC ;
...
-- 2.6
-- SELECT * FROM Foods WHERE ServingSize = '1cup';
...
-- 2.9
-- DELETE FROM Foods WHERE C = '0' AND Fiber < '40';
-- SELECT * FROM Foods;
